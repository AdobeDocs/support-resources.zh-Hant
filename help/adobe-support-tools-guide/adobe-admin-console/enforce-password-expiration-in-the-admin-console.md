---
title: 在Admin Console中強制密碼過期
description: 瞭解組織系統管理員如何在Adobe Admin Console中為其使用者設定密碼過期時間限制。
...
1. 移至[Adobe Admin Console](https://adminconsole.adobe.com/settings) **[!UICONTROL 設定]**&#x200B;區段，並展開左上方的&#x200B;**[!UICONTROL 隱私權與安全性]**&#x200B;選項。
