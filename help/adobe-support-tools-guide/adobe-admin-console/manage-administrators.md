...
在Global Admin Console中，您可以選取組織並導覽至&#x200B;**[!UICONTROL 管理員]**&#x200B;索引標籤，以新增、編輯或移除管理員許可權。 若要瞭解更多資訊，請參閱[採用全域管理](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/adopt-global-administration)。 前往這裡[登入Admin Console](https://adminconsole.adobe.com)。
