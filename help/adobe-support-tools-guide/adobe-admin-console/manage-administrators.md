...
在Global Admin Console中，您可以選取組織並導覽至&#x200B;**[!UICONTROL 管理員]**&#x200B;索引標籤，以新增、編輯或移除管理員許可權。 若要瞭解更多資訊，請參閱[採用全域管理](https://helpx.adobe.com/tw/enterprise/global-admin-console/adopt-global-administration.html)。 移至[Global Admin Console](https://global-admin-console.adobe.com/)登入。
...
全域管理員是一個可轉移的角色。 讓使用者成為組織的全域管理員會自動讓該使用者直接或間接成為該組織所有子項的全域管理員。 此外，如果在組織階層中建立新組織，則該組織任何父項的所有全域管理員將立即成為新建立組織的全域管理員。
...
透過管理管理員，全域管理員可以將使用者、產品授權和群組的管理委派並分發給每個組織的管理員。 由全域管理員新增到組織的管理員，可以靈活地管理組織，而不會看到其他組織的管理。 因此，全域管理員可以委派資源的管理，以及讓這些資源上的資料與使用者隔離的使用者。
...
1. 選取&#x200B;**[!UICONTROL 新增管理員]**。
   ...
   ![全域Admin Console新增管理員](../assets/global-admin-console-add-admin.png)
...
1. 從&#x200B;**[!UICONTROL 管理員許可權]**&#x200B;區段中選取一或多個管理員角色。
   ...
   ![全域Admin Console新增管理員](../assets/global-admin-console-add-admin-detail.png)
...
新增管理員後，他們會收到電子郵件訊息，邀請他們接受其角色，並給他們提供Admin Console的連結。 如果他們同時被新增為全域管理員和某些其他角色，他們將收到兩個邀請，一個用於全域管理控制檯的邀請，一個用於Admin Console。
...
1. 選取相關管理員的&#x200B;**[!UICONTROL 更多選項]** (⋮)圖示，然後選取&#x200B;**[!UICONTROL 編輯管理員]**。
   ...
   ![全域admin console編輯管理許可權](../assets/global-admin-console-edit-admin-right.png)
...
1. 選取相關管理員的&#x200B;**[!UICONTROL 更多選項]** (⋮)圖示，然後選取&#x200B;**[!UICONTROL 移除管理員許可權]**。
   ...
   ![全域Admin Console移除管理員許可權](../assets/global-admin-console-remove-admin-right.png)
