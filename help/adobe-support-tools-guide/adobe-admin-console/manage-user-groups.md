...
5. 選取&#x200B;**[!UICONTROL 檢閱擱置的變更]**&#x200B;以檢閱更新。 然後，選取&#x200B;**[!UICONTROL 提交變更]**&#x200B;以[執行](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/execute-jobs)它們。
...
8. 選取&#x200B;**[!UICONTROL 檢閱擱置的變更]**&#x200B;以檢閱更新。 然後，選取&#x200B;**[!UICONTROL 提交變更]**&#x200B;以[執行](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/execute-jobs)它們。
...
7. 選取&#x200B;**[!UICONTROL 檢閱擱置的變更]**&#x200B;以檢閱更新。 然後，選取&#x200B;**[!UICONTROL 提交變更]**&#x200B;以[執行](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/execute-jobs)它們。
...
4. 選取&#x200B;**[!UICONTROL 檢閱擱置的變更]**&#x200B;以檢閱更新。 然後，選取&#x200B;**[!UICONTROL 提交變更]**&#x200B;以[執行](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/execute-jobs)它們。
...
4. 在您編輯組織後，請選取&#x200B;**[!UICONTROL 檢閱擱置的變更]**&#x200B;以檢閱這些變更。 然後，選取&#x200B;**[!UICONTROL 提交變更]**&#x200B;以[執行](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/execute-jobs)它們。
