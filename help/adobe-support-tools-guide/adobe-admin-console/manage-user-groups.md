...
在[Global Admin Console](https://experienceleague.adobe.com/zh-hant/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/adopt-global-administration)中，選取組織並導覽至&#x200B;**[!UICONTROL 使用者群組]**。 使用單一使用者管理來源在多個組織間共用群組，以同步使用者和群組。 前往這裡[登入Global Admin Console](https://global-admin-console.adobe.com)。
...
5. 選取&#x200B;**[!UICONTROL 檢閱擱置的變更]**&#x200B;以檢閱更新。 然後，選取&#x200B;**[!UICONTROL 提交變更]**&#x200B;以[執行](https://experienceleague.adobe.com/zh-hant/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/set-up-organizations)它們。
...
8. 選取&#x200B;**[!UICONTROL 檢閱擱置的變更]**&#x200B;以檢閱更新。 然後，選取&#x200B;**[!UICONTROL 提交變更]**&#x200B;以[執行](https://experienceleague.adobe.com/zh-hant/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/set-up-organizations)它們。

   記錄群組預測事件以供您參考。 瞭解[檢視和下載稽核記錄](https://experienceleague.adobe.com/zh-hant/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/download-audit-logs-and-export-reports)。
...
7. 選取&#x200B;**[!UICONTROL 檢閱擱置的變更]**&#x200B;以檢閱更新。 然後，選取&#x200B;**[!UICONTROL 提交變更]**&#x200B;以[執行](https://experienceleague.adobe.com/zh-hant/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/set-up-organizations)它們。
...
4. 選取&#x200B;**[!UICONTROL 檢閱擱置的變更]**&#x200B;以檢閱更新。 然後，選取&#x200B;**[!UICONTROL 提交變更]**&#x200B;以[執行](https://experienceleague.adobe.com/zh-hant/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/set-up-organizations)它們。
...
4. 在您編輯組織後，請選取&#x200B;**[!UICONTROL 檢閱擱置的變更]**&#x200B;以檢閱這些變更。 然後，選取&#x200B;**[!UICONTROL 提交變更]**&#x200B;以[執行](https://experienceleague.adobe.com/zh-hant/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/set-up-organizations)它們。
