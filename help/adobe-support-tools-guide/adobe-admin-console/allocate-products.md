...
在[Global Admin Console](https://helpx.adobe.com/tw/enterprise/global-admin-console/adopt-global-administration.html)中，移至&#x200B;**[!UICONTROL 產品配置]**&#x200B;標籤，並選取要配置給子組織的產品。

登入[Global Admin Console](https://adminconsole.adobe.com/support)。
...
>[!WARNING]
>
>您無法從具有&#x200B;**過期**&#x200B;的合約或組織處於&#x200B;**非作用中**&#x200B;狀態的子組織，配置產品給子組織。 深入瞭解[合約到期日](https://helpx.adobe.com/tw/enterprise/using/contract-expiry.html)，或連絡您公司的管理員以取得協助，避免子組織中的使用者無法存取其Adobe應用程式和服務。
...
Global Admin Console中的&#x200B;**[!UICONTROL 產品配置]**&#x200B;索引標籤會顯示跨組織階層購買之產品的配置單位。 作為[全域系統管理員](https://helpx.adobe.com/tw/enterprise/global-admin-console/manage-administrators.html#admins)，您可以將這些產品資源配置給組織樹狀結構中的其他組織，並指定要配置的數量。 作為[全域檢視器](https://helpx.adobe.com/tw/enterprise/global-admin-console/manage-administrators.html#admins)，您可以檢視及匯出資料，但無法進行任何更新。
...
1. 完成資源配置後，選取&#x200B;**[!UICONTROL 檢閱擱置的變更]**。 檢閱後，選取&#x200B;**[!UICONTROL 提交變更]**&#x200B;以[執行](https://helpx.adobe.com/tw/enterprise/global-admin-console/execute-jobs.html)它們。
...
進一步瞭解[在Admin Console中管理Adobe Acrobat Sign](https://helpx.adobe.com/tw/enterprise/using/adobe-sign-for-enterprise.html)。
...
- 如果兩個組織擁有相同的合約，您可以連絡您的Adobe代表或[提交支援](https://helpx.adobe.com/tw/enterprise/using/support-for-enterprise.html)案例，指定Global Admin Console中的&#x200B;**[!UICONTROL 產品配置]**&#x200B;已封鎖，以要求配置產品的許可權。

## 過度配置

作為[全域系統管理員](https://helpx.adobe.com/tw/enterprise/global-admin-console/manage-administrators.html#admins)，您可以允許資源過度配置。
...
[進一步瞭解合約到期日](https://helpx.adobe.com/tw/enterprise/using/contract-expiry.html)，或連絡您公司的管理員以取得協助，以防止子組織中的使用者無法存取其Adobe應用程式和服務。
