...
在[Global Admin Console](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/adopt-global-administration)中，移至&#x200B;**[!UICONTROL 產品配置]**&#x200B;標籤，然後選取要配置給子組織的產品。 全域管理員會向下配置階層；他們不會將授權指派給一般使用者，而工作仍會保留在每個子Adobe Admin Console中。
