...
在[Global Admin Console](https://helpx.adobe.com/enterprise/global-admin-console/adopt-global-administration.html)中，移至&#x200B;**[!UICONTROL 產品配置]**&#x200B;標籤，並選取要配置給子組織的產品。
...
作為[全域系統管理員](https://helpx.adobe.com/enterprise/global-admin-console/manage-administrators.html#admins)，您可以允許資源過度配置。
