...
身為[全域系統管理員](https://experienceleague.adobe.com/zh-hant/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/manage-administrators)，您可以編輯任何父或子組織的名稱，以協助使用者在登入Creative Cloud產品和服務時識別正確的設定檔。
...
作為[全域系統管理員](https://experienceleague.adobe.com/zh-hant/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/manage-administrators)，您可以使用&#x200B;**[!UICONTROL 變更階層]**&#x200B;按鈕，重新父級組織階層中的組織。
