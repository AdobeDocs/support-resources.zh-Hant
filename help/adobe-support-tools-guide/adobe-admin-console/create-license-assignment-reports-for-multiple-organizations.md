...
2. 在&#x200B;**[!UICONTROL 授權指派]**&#x200B;頁面上，選取&#x200B;**[!UICONTROL 建立報告]**。
3. 選取組織並選取&#x200B;**[!UICONTROL 下一步]**。 您可以使用&#x200B;**[!UICONTROL 全選]**&#x200B;按鈕，個別挑選每個組織或選取父項內的所有子組織。
   &#x200B;> [!NOTE]
   >
   >**瞭解無法選取特定組織的原因**：
   ...
   >
   > 您只能為具有有效合約的組織建立指定報表。
4. 選取要包含在報告中的產品，然後選取&#x200B;**[!UICONTROL 下一步]**。
   &#x200B;> [!NOTE]
   >
   >**瞭解無法選取特定產品的原因**：
...
5. 選取要按月或年彙總報表。
6. 選取自訂日期範圍或從預設集選項中選擇。 您可以挑選從2020年6月18日開始直到前一天的任何開始日期，只要該日期不在合約開始日期之前。
7. 選取「下載&#x200B;**&#x200B;**」將報表匯出為CSV檔案。
