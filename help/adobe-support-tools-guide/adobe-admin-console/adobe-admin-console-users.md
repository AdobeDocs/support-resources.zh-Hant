...
- [管理管理員角色](https://helpx.adobe.com/enterprise/using/admin-roles.html)
...
<td><strong>Admin Console</strong>中的<strong>使用者</strong>索引標籤。 <a href="https://helpx.adobe.com/enterprise/using/manage-users-individually.html#add-users">閱讀更多</a>。</td>
...
<td>在<strong>Admin Console</strong>中選取並移除使用者。 <a href="https://helpx.adobe.com/enterprise/using/manage-users-individually.html#remove-users">閱讀更多</a>。</td>
...
<td>選取使用者，然後在Admin Console中<strong>編輯使用者詳細資訊</strong>。 <a href="https://helpx.adobe.com/enterprise/using/manage-users-individually.html#edit-user-details">閱讀更多</a>。</td>
...
- [將授權指派給Team使用者](https://helpx.adobe.com/enterprise/using/assign-licenses-to-teams-users.html)
- [商務儲存模式](https://helpx.adobe.com/enterprise/kb/business-storage-model-introduction.html)
