...
由一般使用者建立、擁有和管理。 Adobe會執行驗證，而一般使用者會管理身分。 根據[儲存模式](https://helpx.adobe.com/tw/enterprise/using/storage-for-business.html)，使用者或企業仍可控制檔案和資料。

對於已更新為企業儲存模式的組織，資產和資料由組織控制。 對於尚未更新的組織，此個人擁有並控制Adobe ID資產。

### Enterprise ID

由組織建立、擁有和管理。 Adobe會託管Enterprise ID並執行驗證，但組織會維護Enterprise ID。 管理員會建立Enterprise ID並核發給使用者。 管理員可以接管帳戶或刪除Enterprise ID以永久封鎖相關資料的存取權，藉此撤銷對產品和服務的存取權。 若要深入瞭解，請按一下[這裡](https://helpx.adobe.com/tw/enterprise/using/setup-enterprise-id.html)。
...
Adobe正在將所有組織更新至[企業儲存模型](https://helpx.adobe.com/tw/enterprise/using/storage-for-business.html)。 這可讓貴組織更好地控制使用者的資產和資料。
...
請參閱[使用Enterprise ID設定組織](https://helpx.adobe.com/tw/enterprise/using/setup-enterprise-id.html)，以取得建立Enterprise ID目錄的要求和步驟。
...
**Azure AD** （建議使用） - [設定SSO並與Azure AD Connector進行使用者同步](https://helpx.adobe.com/tw/enterprise/using/sso-setup-azure.html)

**其他SAML IdP** - [與其他SAML提供者設定SSO](https://helpx.adobe.com/tw/enterprise/using/create-directory.html)

**Google** （建議） - [使用Google Connector設定SSO和使用者同步](https://helpx.adobe.com/tw/enterprise/using/setup-sso-google.html)
...
- [變更IdP](https://helpx.adobe.com/tw/enterprise/using/migrate-authentication-provider.html)而不中斷使用者的工作
- [跨目錄移動網域](https://helpx.adobe.com/tw/enterprise/using/manage-domains-directories.html#move-domains-across-directories)
- [移除舊版目錄使用者](https://helpx.adobe.com/tw/enterprise/using/manage-directory-users.html)
- [刪除舊/無人認領的網域和空白目錄](https://helpx.adobe.com/tw/enterprise/using/manage-domains-directories.html#delete)
...
- [拒絕存取的使用者](https://helpx.adobe.com/tw/enterprise/using/sso-setup-azure.html#sync-issues)
- [同步處理問題](https://helpx.adobe.com/tw/enterprise/using/sso-setup-azure.html#sync-issues)

### 其他SAML IdP — 常見問題集和疑難排解

#### 常見問題集

[SAML整合常見問題集](https://helpx.adobe.com/tw/enterprise/using/sso-faq.html)

#### 疑難排解

- [一般SSO疑難排解](https://helpx.adobe.com/tw/enterprise/kb/tshoot-fed-id.html)
- [「拒絕存取」錯誤](https://helpx.adobe.com/tw/enterprise/kb/tshoot-fed-id.html#Error_Access_Denied_logging_in)
- [「另一個使用者目前登入」錯誤](https://helpx.adobe.com/tw/enterprise/kb/tshoot-fed-id.html#ErrorAnotheruseriscurrentlyloggedin)
- [執行SAML追蹤](https://helpx.adobe.com/tw/enterprise/kb/perform-a-saml-trace.html)
...
若要共同作業、提出問題並與其他管理員交談，請使用[企業和Teams社群](https://www.adobe.com/go/entcom_tw)。
