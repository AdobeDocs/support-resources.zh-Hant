...
1. 在&#x200B;**[Adobe Admin Console](https://adminconsole.adobe.com/)**&#x200B;中，選擇&#x200B;**[!UICONTROL 使用者]** > **[!UICONTROL 系統管理員]**。
...
1. 在&#x200B;**[!UICONTROL Adobe Admin Console]**&#x200B;中，選擇&#x200B;**[!UICONTROL 使用者]** > **[!UICONTROL 系統管理員]**。

   此時會顯示現有管理員清單。

1. 按一下&#x200B;**[!UICONTROL 新增管理員]**。

   顯示&#x200B;**[!UICONTROL 新增管理員]**&#x200B;畫面。
...
使用者必須按一下電子郵件中的**[!UICONTROL 開始使用]**&#x200B;才能加入組織。
...
身為管理員，您可以編輯在管理階層中位於您之下的其他管理員的管理員角色。 例如，您可以移除其他管理員的管理員許可權。

若要編輯管理員角色：

1. 在&#x200B;**[!UICONTROL Adobe Admin Console]**&#x200B;中，選擇&#x200B;**[!UICONTROL 使用者]** > **[!UICONTROL 系統管理員]**。 現有管理員清單隨即顯示。
