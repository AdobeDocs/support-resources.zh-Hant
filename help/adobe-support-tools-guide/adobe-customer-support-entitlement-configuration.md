...
如需詳細資訊，請參閱管理角色檔案中的[編輯企業管理員角色](adobe-admin-console/admin-roles.md#edit-enterprise-admin-role)指示。 請注意，只有您組織的系統管理員可以指派此角色。 如需管理階層的詳細資訊，請瀏覽[管理角色](adobe-admin-console/admin-roles.md)檔案。
