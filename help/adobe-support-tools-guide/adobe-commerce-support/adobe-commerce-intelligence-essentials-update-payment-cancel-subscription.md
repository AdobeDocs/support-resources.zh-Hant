...
若要讓Commerce Intelligence Essentials客戶取消其訂閱或更新其付款方法，他們必須是Magento帳戶的主要帳戶持有者。 步驟如下：

1. 導覽至[account.magento.com](https://account.magento.com)並登入。
2. 按一下&#x200B;**[!UICONTROL Magento]** > **[!UICONTROL 我的產品和服務]** > **[!UICONTROL Magento Business Intelligence]**，然後按一下您要更新的授權旁的&#x200B;**[!UICONTROL 顯示詳細資料]**。
3. 選取&#x200B;**[!UICONTROL 更新付款方式]**&#x200B;或&#x200B;**[!UICONTROL 取消授權]**。
