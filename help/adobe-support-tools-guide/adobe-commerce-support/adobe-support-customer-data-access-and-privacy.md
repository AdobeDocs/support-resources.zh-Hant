...
>[!NOTE]
>
>「隱私權設定」標籤僅對擁有與付費/購買產品相關的支援權益的使用者，以及作為主要MageID並直接獲得授權的使用者可用/可見；此標籤無法透過共用存取委派給其他使用者。 授與存取權後，可能需要5-10分鐘的時間才能更新所有內部Adobe系統。 如果在票證提交前未授予存取權，則主要帳戶擁有者需要以明確的資料存取同意來更新票證。

若要授權存取：

1. [以授權主要使用者的支援身分登入](https://account.magento.com/customer/account/login)。
1. 在&#x200B;**[!UICONTROL 我的帳戶]**&#x200B;頁面> **[!UICONTROL 帳戶設定]**&#x200B;上，確定您已完成[帳戶設定檔](https://account.magento.com/customer/account/edit)，然後按一下&#x200B;**[!UICONTROL 儲存]**。
