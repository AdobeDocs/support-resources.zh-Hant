...
系統深入分析會出現在整個案例建立工作流程中。 輸入問題詳細資訊後，**[!UICONTROL 系統深入分析]**&#x200B;面板會顯示在畫面右側，在AI支援的建議區段上方。 若要深入瞭解AI支援的建議，請參閱Adobe客戶支援體驗文章中的[填寫支援票證](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-customer-support-experience#fill-out-the-support-ticket)。
