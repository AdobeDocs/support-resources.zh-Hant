...
![新增](../adobe-support-tools-guide/assets/new.svg)案例表單已組織成引導流程，協助使用者瞭解每個階段需要哪些資訊：
...
![Fix](../adobe-support-tools-guide/assets/fix.svg)已新增星號(*)作為必要欄位指標，以確保完整度並減少提交錯誤。
