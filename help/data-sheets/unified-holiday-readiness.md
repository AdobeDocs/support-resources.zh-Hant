...
* 使用RAM （[[!UICONTROL 中的]報告活動管理員](https://experienceleague.adobe.com/en/docs/analytics-platform/using/reporting-activity-manager/reporting-activity-overview)）來找出有問題的使用者、查詢或專案；視需要排定優先順序並終止/取消。
