...
description: AEP、AJO、CJA、Commerce、AEM、Marketo、Workfront、Campaign、Analytics和Target的Adobe DX假日整備可協助您規劃、縮放、保護和最佳化。
...
遵循[規劃與樞紐分析：2025年旺季的戰略方針](https://experienceleague.adobe.com/en/perspectives/planning-and-pivoting-a-strategic-approach-to-peak-season-2025)指南中的建議，該指南使用Adobe Commerce (和選用的Adobe Experience Cloud工具)提供可操作的策略，以協助您規劃、樞紐分析並在一年中最繁忙的時段提供傑出的客戶體驗。
