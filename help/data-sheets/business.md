...
Adobe Experience Cloud 業務支援服務提供聯繫 Adobe 技術支援團隊及帳戶支援負責人的完整功能，以進行帳戶管理。
...
| 優先順序 | 線上支援 | 業務支援 |
|--- |--- |--- |
| <b>優先順序 1</b><br>客戶的生產業務功能已停止或發生重大資料遺失或服務降級狀況，需要立即關注以恢復功能與可用性。 | 24x7/<br>1 小時 | 24x7/<br>1 小時 |
| <b>優先順序 2</b><br>客戶的業務功能發生嚴重的服務降級狀況，或是可能發生資料遺失，或是主要功能受到影響。 | 營業時間/<br>4 小時 | 營業時間/<br>2 小時 |
...
<tr>
  ...
  <td>
    ...
    <div>
    <p><b>即時電話支援</b></p>
    <p>客戶可以在地區支援期間透過電話提交所有 P2、P3、P4 問題的支援案件。 您可以致電請求支援的次數沒有上限。 客戶也可以要求支援人員回電，或是請求透過會議進行示範，或是使用共用遠端桌面工作階段來解決問題。</p>
    </div>
  </td>
  <td>
...
<tr>
  <td>
    ...
    <div>
    <p><b>業務服務</b></p>
    <p>帳戶支援負責人將會主持網路研討會來介紹業務支援服務的概觀資訊。</p>
    </div>
  </td>
  <td>
  </td>
...
<tr>
  <td>
    ...
    <p>社群論壇</p>
    <p><b>線上論壇</b></p>
    <p>可持續在線上存取不斷增加的技術解決方案、產品文件、常見問答等內容的資料庫。 成千上萬的客戶可以互相交流，以分享學到的最佳實務和經驗教訓。</p>
    </div>
  </td>
  <td>
...
| [業務支援網站](https://helpx.adobe.com/tw/support/programs/enterprise-support-programs/premier-support-business.html) | Adobe 業務支援網站。 |
