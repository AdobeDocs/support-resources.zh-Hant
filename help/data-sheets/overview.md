...
本檔案概述AdobeDX支援案例生命週期的改進專案，旨在增加溝通，並儘快為客戶提供解決方案，以協助確保客戶取得成功。 以下是在支援流程中遇到的各種情境的時間表和通知：

**案例後續提醒**

| 通知 | 案例狀態 | 通知時間 | 案件結束狀態的天數 |
|--- |--- |--- |--- |
| **1st** | 提供擱置的回應或解決方案 | 24小時/ 1天 | 5 天 |
| **2nd** | 提供未決回應或解決方案 | 72小時/ 3天 | 3 天 |
| **3rd** | 提供擱置的回應或解決方案 | 120小時/ 5天 | 1 天 |
| **4th** | 提供的擱置回應或解決方法已變更為「自動關閉」 | 144小時/ 6天 | 已關閉 |
...
* 在狀態設為「已提供解決方案」後的第1、3與5天，會傳送後續通知給客戶，要求確認所提供的解決方案。
