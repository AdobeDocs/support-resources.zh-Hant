...
| **技術客戶總監附加元件**<br>&#x200B;您的首席技術資源，負責提供領導階層監督、擁有高階主管參與能力，並確保治理，讓您獲取最大的業務成果 | ![無法使用的圖示](assets/Cross_red_circle.svg){width="20"} 不可用 | ![可用圖示](assets/Plus_blue.svg){width="20"} 可用 |
...
| **優先順序佇列套件附加元件**<br>&#x200B;略過此行，先透過額外的Mentor Sessions和Developer Boost存取權讓您的票證正常運作 | ![可用圖示](assets/Plus_blue.svg){width="20"} 可用 | ![已包含圖示](assets/green_checkmark.svg){width="20"} 已包含 |
