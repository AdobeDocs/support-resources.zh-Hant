...
Adobe成功計畫超越了被動式問題解決方案，為您帶來全新的個人化體驗，讓您的業務步驟領先於任何問題。 您的Adobe團隊採用深厚的技術專業知識、多樣化的功能和進階方法，為您提供所需的適當支援、專業知識以及技術和策略指導。

## 專家與最終成功計畫比較

|  | 專家成功計畫 | 最終成功計畫 |
|--- |--- |--- |
|  | 專家成功計畫可讓您存取 **全年無休的專家服務** 進行技術疑難排解，並提供重要業務問題的相關指引。 或者，您可以利用我們的自助資源、獨家最佳作法以及 Adobe 專家和同行的線上社群，找到快速解決方案。 <p> *隨附在所有 Adobe Experience Cloud 授權中。* | 透過終極成功計畫，您將體驗 **策略性指引和主動的技術健康狀態，提供高效能的數位體驗**. 您的Adobe環境將由熟悉您的業務並專注於執行符合您業務影響目標和優先順序的藍圖的專家團隊支援。 |
| **成功團隊** | 彙集支援工程師團隊 | 包括： <ul><li> 指定的技術客戶經理 </li><li> 指定的客戶成功經理 </li><li> 指定的支援服務管理員</li><li> 由技術工程師和策略專家組成的小組，提供「成功加速器」 </li><li> 彙集支援工程師團隊 </li></ul> |
| **主動式技術 + 營運支援** | ![不包含圖示](assets/Cross_red_circle.svg){width="20"} 不包含 | 包括： <ul><li>升級和移轉檢閱、發行準備 </li><li>產品藍圖審查</li><li> 技術與策略藍圖保持一致</li><li>重要活動的準備與規劃</li><li>規劃相關且及時的啟用</li><li>技術最佳實務和產業指引</li><li>倡導/調整產品團隊</li><li>達成關鍵業務目標的統一計畫 — 共同作業計畫(MAP)</li></ul> |
| **技術支援** | 包括： <ul><li>**P1**：全年無休的問題支援</li><li>**P2、P3、P4**：營業時間支援</li><li>標準中斷管理</li><li>匯集的向上呈報管理</li></ul> | 包括： <ul><li>**P1**：全年無休的問題支援</li><li>**P2/P3**：24x5問題支援</li><li>**P4**：營業時間支援</li><li>有優先權的中斷管理</li><li>指定專家向上呈報管理</li></ul> |
| **成功加速器** | ![不包含圖示](assets/Cross_red_circle.svg){width="20"} 不包含 | TAM和CSM定期排程成功加速器<p>*（如需詳細資訊，請參閱成功加速器目錄）* |
| **支援管道** | 線上、電話、Experience League、論壇 | 個人化的線上入口網站、優先處理的電話、Experience League、論壇 |
